...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void videoInitialize() async {
    ...
    // load video from URL
    // final videoController = VideoPlayerController.networkUrl(Uri.parse("https://github.com/dicodingacademy/assets/releases/download/release-video/VideoDicoding.mp4"));
